...
class ResponsiblesControllerTest < ActionController::TestCase
  ...
  test "should create responsible" do
    assert_difference('Responsible.count') do
      post :create, responsible: { code: @responsible.code, end_time: @responsible.end_time, start_time: @responsible.start_time }
    end
  ...
  test "should update responsible" do
    patch :update, id: @responsible, responsible: { code: @responsible.code, end_time: @responsible.end_time, start_time: @responsible.start_time }
    assert_redirected_to responsible_path(assigns(:responsible))
  end
