...
ActiveRecord::Schema.define(version: 20151202233752) do
  ...
  add_index "tecnicos", ["email"], name: "index_tecnicos_on_email", unique: true, using: :btree
  add_index "tecnicos", ["reset_password_token"], name: "index_tecnicos_on_reset_password_token", unique: true, using: :btree
